    ...
    <div class="card card-gray">
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="card_navigation" role="tablist">
                <li class="pt-1 px-3"><h3>Cadastrar funcionario</h3></li>
                <li class="nav-item">
        ...
        <div class="card-body" style="background-color: lightslategray">
            <form action="{{route('source.employees.store')}}" method="POST">
                @csrf
                            ...
                            <div class="row">
                                <div class="col-md-3 py-2">
                                    ...
                                    <select name="married" id="married" class="form-control select2">
                                        <option>-------------</option>
                                        <option value="1" {{old('married') == "1" ? 'selected' : ''}}>Sim</option>
                                        <option value="0" {{old('married') == "0" ? 'selected' : ''}}>Não</option>
                                    </select>
                                </div>
                                <div class="col-md-3  py-2">
                                    ...
                                    <select name="children" id="children" class="form-control select2">
                                        <option>-------------</option>
                                        <option value="1" {{old('children') == "1" ? 'selected' : ''}}>Sim</option>
                                        <option value="0" {{old('children') == "0" ? 'selected' : ''}}>Não</option>
                                    </select>
                                </div>
                                <div class="col-md-3 py-2">
                    ...
                    <div class="tab-pane fade" id="bank_data" role="tabpanel" aria-labelledby="bank_data">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="bank" id="bank" class="form-control input-sm {{(!empty($errors->messages()['bank'])? MessagesInputs::isInvalid($errors->messages()['bank']) : '')}}" value="{{old('bank')}}">
                            </div>
                            <div class="col-md-3">
